        ...
        <div class="col-12 col-md-8 col-lg-5 col-xl-4">
            ...
            <div class="card glass-card border-0">
                <div class="card-body p-4 p-lg-5">
                    ...
                    @if (session('error'))
    <div class="alert alert-danger border-0 bg-danger text-white small mb-4" style="border-radius: 12px; background: rgba(220, 38, 38, 0.8) !important; backdrop-filter: blur(10px);">
...
@if ($errors->any())
    <div class="alert alert-danger border-0 text-white small mb-4" style="border-radius: 12px; background: rgba(220, 38, 38, 0.8) !important; backdrop-filter: blur(10px);">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-input-group">
                                <input type="email" name="email" class="input-field" placeholder="nama@email.com" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-input-group">
                                <input type="password" name="password" id="psw_input" class="input-field" placeholder="••••••••" required>
