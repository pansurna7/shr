                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white">Manage Menu</h5>
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="text-center mt-5">
                                   <button type="submit" class="btn btn-light px-5"><i class="bx bx-save"></i>Save</button>
                                    <a type="btn btn-light" href="{{ route('menus.index',$menu->id) }}" class="btn btn-light px-5"><i class="lni lni-arrow-left-circle"></i>Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
