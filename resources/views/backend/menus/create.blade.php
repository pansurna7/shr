                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white">Create Menu</h5>
                        </div>
                        <hr>
                        <form method="POST" action="{{ route('menus.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a type="btn btn-light" href="{{ route('menus.index') }}" class="btn btn-light px-5"><i class="lni lni-arrow-left-circle"></i>Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
